# ============================================================
# CẤU HÌNH A — PHIÊN BẢN 1: KHÔNG SET QUALITY (mặc định/auto)
...
output_dir = os.path.join(drive_path, "cau_hinh_A_auto_quality")
SIZE = (1024, 1024)
...
for idx, filename in enumerate(image_files):
    ...
    try:
        ...
        # === GIỐNG HỆT GỐC — 1 lần gọi API duy nhất với n=3, KHÔNG có tham số quality ===
        result = client.images.edit(
            ...
            n=N_SYNTHETIC,
            size="1024x1024"
            # <-- Không có "quality" ở đây, ĐÚNG như code gốc tác giả
        )
...
print("\n=== HOÀN TẤT — Phiên bản KHÔNG set quality ===")
